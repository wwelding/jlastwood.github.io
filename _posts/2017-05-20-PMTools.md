...
I subscribe to both the iterative and incremental development model which includes Agile methodologies.   I use Kanban model more often than Scrum in teams that are globally disbursed and have daily chat times, and weekly standup meetings via conference call.  
